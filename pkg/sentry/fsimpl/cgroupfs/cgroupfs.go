...
// stubControllerFile is a writable control file that remembers and repeats the
// control value written to it. The data pointer is accessed through atomic ops,
// external access should also be serialized by atomic ops.
//
// +stateify savable
...
// newStaticControllerFile creates a new stub controller file tbat loads and
// stores a control value from data. Access to data is synchronized through
// atomic ops.
